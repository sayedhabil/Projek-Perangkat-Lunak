...
<html lang="en">
        ...
        <div class=" sidebar col-sm-auto sticky-top" >
          <div class="d-flex flex-sm-column flex-row flex-nowrap align-items-center sticky-top" >
            <ul class="nav nav-pills nav-flush flex-sm-column flex-row flex-nowrap mb-auto mx-auto text-center align-items-center">
              ...
              <!-- HISTORY -->
              <li>
                <a href="historyDokter.php" class="font nav-link py-3 px-2 selected" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="History">
              ...
              <div class="card-body">
                <div class="text-end">
                  <div class="d-inline-flex bd-highlight-end">
                    <input id="kata" class="form-control search border border-primary text-colour-primary" type="text" style="border-radius: 7px;" placeholder="Search..">
                  </div>
                  <div id="table"class="table table-responsive text-center">
                    <table class="table" id="dataTable">
                      ...
                      <tbody>
                        ...
                        $select_records = "SELECT * FROM pasien WHERE tanggal_konsul IS NOT NULL";
  ...
  <!-- JavaScript Search -->
  <script src="js/scriptHistoryDokter.js"></script>
